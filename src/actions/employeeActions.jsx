...
export const getEmployeeDetails = (empid) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`${URL}/api/employee/${empid}`)
        dispatch({
...
export const createEmployee = (employeeData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.post(`${URL}/api/employee`, employeeData, configs);
        dispatch({
...
export const updateEmployee = (empid, employeeData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.put(`${URL}/api/employee/${empid}`, employeeData, configs)
...
export const deleteEmployee = (empid) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.delete(`${URL}/api/employee/${empid}`)
